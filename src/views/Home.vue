    ...
    <section class="hero">
      ...
      <div class="container hero-inner">
        <div class="hero-text">
          ...
          <p class="hero-sub">
            Calendário vacinal completo do SBIm + comparação de preços entre clínicas da sua cidade. Simples, gratuito e sem complicação.
          </p>
        ...
        <div class="hero-card">
          ...
          <button class="btn-primary card-btn" @click="goToSchedule">
            Ver vacinas necessárias
          </button>
      ...
      <div class="container">
        ...
        <div class="features-grid">
          <div class="feat feat-big">
            ...
            <p>Informe a idade em meses e veja exatamente quais vacinas seu filho precisa — baseado no calendário oficial do SBIm e Ministério da Saúde.</p>
...
function setAge(v) { ageMonths.value = v }
function goToSchedule() {
  router.push(ageMonths.value !== '' ? `/calendario?idade=${ageMonths.value}` : '/calendario')
}
</script>
...
.hero {
  ...
  padding: 80px 0 100px; min-height: 90vh;
...
.shape-1 {
  width: 500px; height: 500px; background: var(--coral-100);
  top: -100px; right: -80px;
  animation: drift 12s ease-in-out infinite;
}
.shape-2 {
  width: 350px; height: 350px; background: var(--amber-100);
  bottom: 0; left: -60px;
  animation: drift 15s ease-in-out infinite reverse;
}
.shape-3 {
  width: 250px; height: 250px; background: var(--blue-100);
  top: 40%; left: 45%;
...
.hero-text h1 em { color: var(--coral-500); font-style: italic; }
.hero-sub {
...
.card-sub { color: var(--text-light); font-size: 0.9rem; margin-bottom: 24px; }
.age-row {
  display: flex; align-items: center; gap: 10px; margin-bottom: 16px;
}
.age-input {
  width: 90px; padding: 12px 16px;
  background: var(--cream); border: 2px solid var(--cream-mid);
  border-radius: var(--radius-sm); font-size: 1.4rem; font-weight: 700;
  color: var(--text-main); text-align: center; transition: border-color 0.2s;
}
.age-input:focus { border-color: var(--coral-400); background: var(--white); }
.age-unit { color: var(--text-mid); font-size: 1rem; }
.card-btn { width: 100%; justify-content: center; margin-bottom: 20px; }
.card-quick {
...
.card-quick button:hover { background: var(--coral-100); color: var(--coral-600); }

/* Stats */
.stats {
  background: var(--text-main); padding: 32px 0;
}
.stats-inner {
...
.stat-item strong {
  ...
  font-size: 1.4rem; color: var(--coral-300);
}
.stat-item span { font-size: 0.8rem; color: var(--brown-200); }
...
.features h2 {
  ...
  font-weight: 800; margin-bottom: 48px; max-width: 560px;
}
.features h2 em { color: var(--coral-500); font-style: italic; }
...
.feat {
  background: var(--white); border-radius: var(--radius-lg);
  padding: 36px; border: 1.5px solid var(--cream-mid);
  transition: all 0.3s; position: relative; overflow: hidden;
}
.feat:hover {
  border-color: var(--coral-200); transform: translateY(-4px);
...
.feat-link {
  ...
  color: var(--coral-500); transition: gap 0.2s;
}
.feat-link:hover { color: var(--coral-700); }
.feat-badge {
...
.feat-deco {
  ...
  background: var(--coral-100); opacity: 0.5;
}
