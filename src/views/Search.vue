...
const { searchQuery, activeFilter, filters, filteredVaccines, clearSearch } = useVaccines();
</script>
        ...
        <div class="container page-body">
            ...
            <div class="vaccines-grid">
                ...
                >
                    ...
                    <div class="diseases">
                        <span v-for="disease in vaccine.diseases" :key="disease" class="disease-tag">
                            {{ disease }}
                        </span>
                    </div>
            ...
            <div v-if="filteredVaccines.length === 0" class="empty-state">
                ...
                <button class="btn-primary" @click="clearSearch">Limpar busca</button>
            </div>
        </div>
    </div>
</template>
